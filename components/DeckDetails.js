...
class DeckDetails extends React.Component {
  ...
  render() {
    const { deck, goAddCard, goQuiz } = this.props;
    return (
...
function mapDispatchToProps(dispatch, { navigation }) {
  const { deckKey } = navigation.state.params;
  return {
    goAddCard: () => navigation.navigate("AddCard", { deckKey: deckKey }),
    goQuiz: () => navigation.navigate("Quiz", { deckKey: deckKey })
  };
}
