      ...
      <View style={styles.mainEle}>
        {isQue && (
          <View style={{ justifyContent: "center", alignItems: "center" }}>
            <Text style={styles.paragraph}>{quizQuestion.question}</Text>
            <TouchableOpacity
              style={styles.buttonEle}
              onPress={e => handleQueAnsView(false)}
            >
        ...
        {!isQue && (
          <View style={{ justifyContent: "center", alignItems: "center" }}>
            <Text style={styles.paragraph}>{quizQuestion.answer}</Text>
            <TouchableOpacity
              style={styles.buttonEle}
              onPress={e => handleQueAnsView(true)}
            >
